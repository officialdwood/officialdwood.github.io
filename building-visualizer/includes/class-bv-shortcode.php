        ...
        <div class="bv-wrap" data-version="<?php echo esc_attr(BV_VERSION); ?>">
            ...
            <div class="bv-container">
                ...
                <div class="bv-preview">
                    ...
                    <div class="bv-view-controls">
                        <h3>View Controls</h3>
                        <div class="bv-control-row">
                            <div class="bv-control-group">
                                <label for="bv-rotation-y">Rotation (Horizontal)</label>
                                <input type="range" id="bv-rotation-y" min="0" max="360" value="225" step="5" />
                                <span id="bv-rotation-y-value">225°</span>
                            </div>
                            <div class="bv-control-group">
                                <label for="bv-rotation-x">Tilt (Vertical)</label>
                                <input type="range" id="bv-rotation-x" min="-45" max="45" value="25" step="5" />
                                <span id="bv-rotation-x-value">25°</span>
                            </div>
                        </div>
                        <div class="bv-control-row">
                            <div class="bv-control-group">
