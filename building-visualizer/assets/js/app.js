    ...
    class BuildingVisualizer {
        constructor() {
            ...
            this.params = {
                ...
                wainscottHeight: 3,
                rotationY: 225, // degrees - horizontal rotation (225 = left-front corner view to match reference image)
                rotationX: 25, // degrees - vertical tilt (25 = looking down from above to match reference)
                zoom: 1 // scale factor
            };
